...
const EmptyState = () => (
  <div style={{
    ...
    <div style={{ fontSize: 15, fontWeight: 600, color: '#64748B' }}>Нет данных о графике ЭК</div>
    <div style={{ fontSize: 13, color: '#94A3B8', textAlign: 'center', lineHeight: 1.6 }}>
      Загрузите и проанализируйте ТЗ в разделе «Анализ ТЗ».<br/>
      После Этапа 3 график ЭК появится здесь автоматически.
    </div>
  </div>
)
      ...
      <div style={{ display: 'flex', alignItems: 'flex-end', gap: 14, flexWrap: 'wrap' }}>
        <div>
          <h1 style={{ margin: 0, fontSize: 22, fontWeight: 700, color: '#0D1117' }}>
            График эксплуатационного контроля
          </h1>
